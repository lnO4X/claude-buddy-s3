...
// Was upstream `class TFT_eSPI;` forward decl; sed → LovyanGFX collides
// with M5GFX library's `using LovyanGFX = lgfx::v1::LovyanGFX` typedef.
// Pull header to use the typedef directly.
#include <M5Unified.h>
